...
@Global()
@Module({
    imports: [Config.getModule(), RedisCache.getModule(), HttpModule, PortalIntApiModule, CrtptionModule, QueueModule],
    providers: [ResponseService, TeamsWebHookService, RedisCacheService, LoggingService, PageNationService],
